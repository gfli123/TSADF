...
parser.add_argument('--num_frames', type=int, default=7, help="Number of input images at a time")
...
# save
parser.add_argument('--log_file', type=str, default='./results/results.log', help="Storage path for logs")
...
parser.add_argument('--train_datasets', type=str, default='Vimeo-90K', help="Select training set, Vimeo-90K and MM522")
